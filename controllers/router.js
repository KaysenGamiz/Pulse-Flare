...
const xml_formatter_router = require(path.join(__dirname, '..' , 'routes', 'general_utils', 'xml_formatter', 'xml_formatter_route.js'));
const readings_router = require(path.join(__dirname, '..', 'routes', 'general_utils', 'temperatures', 'route_reading.js'));
...
router.use('/general_utils/xml_formatter', xml_formatter_router)
router.use('/general_utils/temperatures', readings_router);
